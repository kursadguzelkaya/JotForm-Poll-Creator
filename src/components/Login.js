    ...
    <div className="login">
      ...
      <div className="login-btn-container">
        <button type="button" onClick={() => logInRequest(history)} className="btn">
          <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="sign-in-alt" className="icon svg-inline--fa fa-sign-in-alt fa-w-16" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
