          ...
          <div className="logout">
            <Link to="/">
              <button className="btn logout-btn" type="button" onClick={logOut}>
                <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="sign-out-alt" className="icon svg-inline--fa fa-sign-out-alt fa-w-16" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
